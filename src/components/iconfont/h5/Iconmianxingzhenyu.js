...
const Iconmianxingzhenyu = ({ size, color, style: _style, ...rest }) => {
  const style = _style ? { ...DEFAULT_STYLE, ..._style } : DEFAULT_STYLE;

  return (
    <svg viewBox="0 0 1024 1024" width={size + 'rem'} height={size + 'rem'} style={style} {...rest}>
      <path
        d="M246 828.4c-11 0-20 9-20 20v61.3c0 11 9 20 20 20s20-8.9 20-20v-61.3c0-11-9-20-20-20zM480.4 848.4v61.3c0 11.1-9 20-20 20s-20-9-20-20v-61.3c0-11 9-20 20-20s20 9 20 20z"
        fill={getIconColor(color, 0, '#97EBFF')}
      />
      <path
        d="M674.8 828.4c-11 0-20 9-20 20v61.3c0 11 9 20 20 20s20-8.9 20-20v-61.3c0-11-9-20-20-20z"
...
Iconmianxingzhenyu.defaultProps = {
  size: 18,
};

export default Iconmianxingzhenyu;
